  ...
  <section id="portfolio" className="portfolio section light-background">
    ...
    <div className="container">
      <div className="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
        <ul className="portfolio-filters isotope-filters"   data-aos-delay={100}>
  ...
  <section id="services" className="services section">
    ...
    <div className="container">
      <div className="row gy-4">
        ...
        <div className="col-lg-4 col-md-6 service-item d-flex"   data-aos-delay={300}>
        ...
        <div className="col-lg-4 col-md-6 service-item d-flex"   data-aos-delay={400}>
        ...
        <div className="col-lg-4 col-md-6 service-item d-flex"   data-aos-delay={500}>
        ...
        <div className="col-lg-4 col-md-6 service-item d-flex"   data-aos-delay={600}>
